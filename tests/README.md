...
- **`tests/Integration/`** - Testes de integração completa com Express PHP
...
4. **Integração real** com Express PHP
5. **Mocks mínimos** apenas onde absolutamente necessário

### Limitações Atuais

Devido à complexidade da integração entre Express PHP e Cycle ORM, alguns testes requerem mais trabalho para configuração completa. A versão atual fornece uma base sólida que pode ser expandida.
...
1. Resolver compatibilidades entre versões do Express PHP
