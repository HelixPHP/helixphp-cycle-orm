...
class MockApplication extends \Express\Core\Application
{
    ...
    public function singleton(...$args) { return $this->container->singleton(...$args); }
    public function booted() { return $this->container->booted(); }
    public function alias(...$args) { return $this->container->alias(...$args); }
    public function make(...$args) { return $this->container->make(...$args); }
    ...
    public function has($service) {
        ...
        $known = [
            'cycle.orm', 'cycle.em', 'cycle.database', 'cycle.schema', 'db', 'orm', 'em', 'schema'
        ];
